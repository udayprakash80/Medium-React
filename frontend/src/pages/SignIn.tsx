...
import {SignInType} from "@udayprakash80/common-medium";
      ...
      <div className="h-screen flex justify-center flex-col">
        <div className= "flex flex-row min-h-screen justify-center items-center">
          <div className="bg-white rounded-lg p-5">
            ...
            <div className="pt-5">
              <button onClick={sendRequest} className="bg-slate-900 p-3 text-white w-full rounded-lg text-lg">Sign In</button>
            </div>
          </div>
        </div>
      </div>
